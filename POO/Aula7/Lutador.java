...
public class Lutador {
    ...
    public void ganharLuta(String vencedor, String perdedor){
        this.vitorias += 1;
        System.out.println(vencedor + " venceu! " + perdedor + " perdeu...");
    }
    public void perderLuta(){
        this.derrotas += 1;
    }
    public void empatarLuta(String empate1, String empate2){
        this.empates += 1;
        System.out.println(empate1 + " e " + empate2 + " empataram!");
    }
...
//        fim da luta
        vencedor.ganharLuta(vencedor.getNome(), perdedor.getNome());
        perdedor.perderLuta();
