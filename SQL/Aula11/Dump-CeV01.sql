-- Criação do banco (em PostgreSQL, deve ser executada separadamente por segurança)
-- CREATE DATABASE cadastro;

-- Conecte-se ao banco "cadastro" antes de executar os comandos abaixo
